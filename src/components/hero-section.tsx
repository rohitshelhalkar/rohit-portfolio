...
export default function HeroSection() {
  ...
  const downloadResume = () => {
    // For a client-side app, you could host the resume as a static file
    const link = document.createElement("a");
    link.href = "/assets/resume.pdf"; // Add your resume PDF to public/assets/
    ...
    <section id="hero" className="pt-20 pb-12 bg-gradient-to-br from-medical-blue/5 to-healthcare-green/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img
              src="/assets/image_1755118941108.jpeg"
